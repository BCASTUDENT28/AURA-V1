...
app = FastAPI(
    title="AURA Backend — Phase 3",
    description=(
        "Decision, risk, cost computation, canonical market data, and quant feature engine. "
        "Persistent research data, standardized BaseStrategy framework, and regime classifier. "
